...
def test_load_type1_fragpipe_dataset():
    ...
    expected_df = pd.DataFrame(
        {
            "A1CF": {"Sample1": 1.2, "Sample2": 1.3},
            "AAAS": {"Sample1": 2.2, "Sample2": 2.3},
            "AAED1": {"Sample1": 3.2, "Sample2": 3.3},
        }
...
def test_load_type2_fragpipe_dataset():
    ...
    expected_df = pd.DataFrame(
        {
            "ACADVL": {"Sample1": 1.2, "Sample2": 1.3},
            "ACAT1": {"Sample1": 2.2, "Sample2": 2.3},
            "ACVRL1": {"Sample1": 3.2, "Sample2": 3.3},
        }
    ).rename_axis(index="sample", columns="gene")
