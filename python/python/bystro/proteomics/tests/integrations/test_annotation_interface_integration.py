...
from bystro.proteomics.annotation_interface import get_samples_and_genes
...
def test_foo():
    ...
    samples_genes_df = get_samples_and_genes(opensearch_client, user_query_string, index_name)
