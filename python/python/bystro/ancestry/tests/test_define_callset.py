...
from bystro.ancestry.define_callset import (
    liftover_38_from_37,
    _process_affymetrix_df,
    _process_illumina_df,
)
...
def test_liftover_38_from_37(test_input, expected):
...
def test__process_affymetrix_df():
    ...
    expected_output = pd.Series(
        {
            "AFFX-SP-000001": "chr10:121336954:C:G",
            "AFFX-SP-000002": "chr12:23048418:C:G",
            "AFFX-SP-000003": "chr10:33256536:G:C",
        }
    )

    assert (expected_output == _process_affymetrix_df(affymetrix_df)).all()
...
def test__process_illumina_df():
    ...
    assert (expected_output == _process_illumina_df(illumina_df)).all()
