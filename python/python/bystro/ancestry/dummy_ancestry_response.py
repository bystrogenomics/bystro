...
from bystro.ancestry.listener import AncestryJobCompleteMessage


def make_dummy_ancestry_response() -> AncestryJobCompleteMessage:
            ...
            [
                AncestryScoresOneSample(
                    ...
                    top_hit=AncestryTopHit(
                        probability=0.5, populations=["AFR", "AMR", "EAS", "EUR", "SAS"]
                    ),
                ...
                AncestryScoresOneSample(
                    sample_id="bar",
                    top_hit=AncestryTopHit(
                        probability=1.0, populations=["AFR", "AMR", "EAS", "EUR", "SAS"]
                    ),
                    populations=PopulationVector(
