        ...
        results=[
            AncestryResult(
                ...
                populations=PopulationVector(
                    ...
                    MAG=ProbabilityInterval(lower_bound=0.0, upper_bound=0.5),
            ...
            AncestryResult(
                ...
                populations=PopulationVector(
                    ...
                    MAG=ProbabilityInterval(lower_bound=0.0, upper_bound=1.0),
            ...
            AncestryResult(
                ...
                populations=PopulationVector(
                    ...
                    MAG=ProbabilityInterval(lower_bound=0.5, upper_bound=1.0),
