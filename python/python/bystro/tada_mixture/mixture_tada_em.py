...
model for Tada, with two flavors, a ZIP and a standard poisson. The 
generative formulation is 
...
MVTadaZPoissonEM(K=4,training_options={})
    ...
    def fit(self, X, progress_bar=True):
        ...
        for i in myrange(td["n_iterations"]):
            ...
            for k in range(K):
                ...
                alpha_k = 0.8 * sigmoid(alpha_list_l[k])  # Prob of being 0
