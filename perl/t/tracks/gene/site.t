...
my $packedData = $siteHandler->pack( ( 0, 'intronic', '-' ) );
...
$packedData = $siteHandler->pack( ( 1541, 'ncRNA', '+' ) );
...
$packedData = $siteHandler->pack( ( 65000, 'exonic', '+', 1, 2, 'ATG' ) );

say "Packed data for (65000, 'Coding', '+', 1, 2, 'ATG') is ";

( $txNumber, $unpackedData ) = $siteHandler->unpack($packedData);

( $strand, $siteType, $codonNumber, $codonPosition, $codonSequence ) =
  @$unpackedData;
